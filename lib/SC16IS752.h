...
{ 
  public:
    ...
    int     read(uint8_t channel, size_t received);
    size_t  write(uint8_t channel, uint8_t val);
    size_t  write(uint8_t channel, const uint8_t *val, size_t received);
    void  write(uint8_t channel, String val);
    ...
    size_t readBytes(const uint8_t *val, size_t received);
  ...
  private:
    ...
    uint8_t  ReadRegister(uint8_t channel, uint8_t reg_addr, size_t received);
    void     WriteRegister(uint8_t channel, uint8_t reg_addr, uint8_t val);
    void     WriteRegister(uint8_t channel, uint8_t reg_addr, const uint8_t *val, size_t received);
    ...
    void    WriteByte(uint8_t channel, const uint8_t *val, size_t received);
    int     ReadByte(uint8_t channel);
    int     ReadByte(uint8_t channel, size_t received);
    //void    EnableTransmit(uint8_t channel, uint8_t tx_enable);
    int     peek_buf;
    uint8_t peek_flag;
